...
public interface PerceptualAssociativeMemory extends FrameworkModule {
	 ...
	 */
    PamNode addDefaultNode(String label);
	 ...
	 *         specified label or null
	 */
    PamNode addNode(String type, String label);
	 ...
	 */
    PamLink addDefaultLink(Node src, Linkable snk, LinkCategory cat);
	 ...
	 * @return the new PamLink, the existing PamLink, or null
	 */
    PamLink addLink(String type, Node src, Linkable snk, LinkCategory cat);
	 ...
	 */
	@Deprecated
    Set<PamNode> addDefaultNodes(Set<? extends Node> nodes);
	 ...
	 */
	@Deprecated
    Set<PamLink> addDefaultLinks(Set<? extends Link> links);
	 ...
	 */
    void receiveExcitation(Set<PamLinkable> linkables, double amount);
	 ...
	 */
    Collection<LinkCategory> getLinkCategories();
