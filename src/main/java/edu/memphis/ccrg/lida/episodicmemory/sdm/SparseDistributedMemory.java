...
public interface SparseDistributedMemory {
	 ...
	 */
    void store(BitVector word, BitVector addr);
	 ...
	 *            the mapping address.
	 */
    void mappedStore(BitVector word, BitVector mapping);
	 ...
	 *         the given address
	 */
    BitVector retrieve(BitVector addr);
	 ...
	 */
    BitVector retrieveIterating(BitVector addr);
	 ...
	 *         the given address or null if the iteration did not converge
	 */
    BitVector retrieveIterating(BitVector addr, BitVector mapping);
