...
public class EpisodicMemoryImpl extends FrameworkModuleImpl implements
	...
	@Override
	public void init() {
		numOfHardLoc = getParam("em.numOfHardLoc", DEF_HARD_LOCATIONS);
		addressLength = getParam("em.addressLength",
				DEF_ADDRESS_LENGTH);
		wordLength = getParam("em.wordLength", DEF_WORD_LENGTH);
		int radius = getParam("em.activationRadius",
				DEF_ACCESS_RADIUS);
