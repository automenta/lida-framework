...
public interface Activatible extends Initializable {
	 ...
	 */
    double DEFAULT_ACTIVATIBLE_REMOVAL_THRESHOLD = 0.0;

	/**
	 * Default activation for {@link Activatible}
	 */
    double DEFAULT_ACTIVATION = 0.0;
	
	/**
	 * Default incentive salience for {@link Activatible}.
	 */
    double DEFAULT_INCENTIVE_SALIENCE = 0.0;
	 ...
	 */
    void exciteActivation(double amount);
	/**
	 ...
	 */
    void exciteIncentiveSalience(double amount);
