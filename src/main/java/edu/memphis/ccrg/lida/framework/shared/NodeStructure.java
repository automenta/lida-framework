...
public interface NodeStructure {
	 ...
	 */
	Node addDefaultNode(String label, double a, double rt);
	 ...
	 *            Node to be added.
	 */
	Collection<Node> addDefaultNodes(Collection<Node> nodes);
	 ...
	 * @return the {@link Node} added to the NodeStructure or null
	 */
	Node addNode(String type, String label, double a, double rt);
	 ...
	 */
	Node addNode(Node n, String type);
	 ...
	 *         present.
	 */
	Link addDefaultLink(Node source, Linkable sink,
	 ...
	 *         present.
	 */
	Link addDefaultLink(int idSource, ExtendedId idSink,
	 ...
	 *         present.
	 */
	Link addDefaultLink(int idSource, int idSink, LinkCategory type,
	 ...
	 */
	Collection<Link> addDefaultLinks(Collection<Link> links);
	 ...
	 *         present.
	 */
	Link addLink(String type, int srcId, ExtendedId snkId,
	 ...
	 *         present.
	 */
	Link addLink(String type, Node src, Linkable sink, LinkCategory cat,
				 double a, double rt);
	 ...
	 */
	Link addLink(Link l, String linkType);
	 ...
	 */
	Set<Link> getLinks(LinkCategory cat);
	 ...
	 *         {@link Linkable}
	 */
	Set<Link> getAttachedLinks(Linkable l);
	 ...
	 * @return Links
	 */
	Set<Link> getAttachedLinks(Linkable lnk, LinkCategory cat);
	 ...
	 */
	Collection<Linkable> getLinkables();
	 ...
	 */
	Map<Linkable, Set<Link>> getLinkableMap();
	 ...
	 */
	Map<Linkable, Link> getConnectedSinks(Node n);
	 ...
	 */
	Map<Node, Link> getConnectedSources(Linkable lnk);
	 ...
	 */
	NodeStructure getSubgraph(Collection<Node> nodes, int d);
