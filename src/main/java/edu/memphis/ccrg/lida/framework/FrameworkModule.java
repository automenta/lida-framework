...
public interface FrameworkModule extends FullyInitializable {
	 ...
	 */
	boolean containsSubmodule(String name);
	 ...
	 * @return the submodule.
	 */
	FrameworkModule getSubmodule(String name);
	 ...
	 */
	Object getModuleContent(Object... params);
	 ...
	 */
	Map<ModuleName, FrameworkModule> getSubmodules();
