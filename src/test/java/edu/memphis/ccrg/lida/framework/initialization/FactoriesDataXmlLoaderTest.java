...
public class FactoriesDataXmlLoaderTest {
	...
	public void testGetStrategies() {
		...
		Map<String, StrategyDef> strats = FactoriesDataXmlLoader.getStrategies(e);
	...
	public void testGetStrategyDef() {
		String xml = "<strategy flyweight=\"true\" name=\"defaultExcite\" type=\"excite\">"
				...
				+ "</strategy>";
		Element e = parseDomElement(xml);
		StrategyDef def = FactoriesDataXmlLoader.getStrategyDef(e);
		...
		def = FactoriesDataXmlLoader.getStrategyDef(e);
	...
	public void testGetLinkables() {
		...
		Map<String, LinkableDef> linkables = FactoriesDataXmlLoader.getLinkables(e, "nodes",
				"node", strategies);
	...
	public void testGetLinkable() {
		...
		LinkableDef def = FactoriesDataXmlLoader.getLinkable(e, strategies);
	...
	public void testGetCodelets() {
		...
		Map<String, FrameworkTaskDef> codelets = FactoriesDataXmlLoader.getTasks(e, strategies);
	...
	public void testGetCodelet() {
		...
		FrameworkTaskDef def = FactoriesDataXmlLoader.getTaskDef(e, strategies);
		assertNotNull(def);
		assertEquals(
				"edu.memphis.ccrg.lida.example.genericlida.featuredetectors.TopLeftDetector",
				def.getClassName());
	...
	public void testCheckStrategies() {
		...
		FactoriesDataXmlLoader.checkStrategies(desiredStrategies, strategies);
