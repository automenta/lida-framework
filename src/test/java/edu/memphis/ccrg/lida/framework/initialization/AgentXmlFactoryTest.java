...
public class AgentXmlFactoryTest {
	...
	public void testGetTaskManager() {
		...
		TaskManager tm = AgentXmlFactory.getTaskManager(docEle);
		assertTrue(tm != null);
		...
		tm = AgentXmlFactory.getTaskManager(docEle);
		assertTrue(tm != null);
	...
	public void testGetTaskSpawner() {
		...
		AgentXmlFactory.getTaskSpawner(docEle, tm, spawners);
		assertEquals(1, spawners.size());
		TaskSpawner ts = spawners.get("defaultTS");
		assertTrue(ts != null);
	...
	public void testGetTaskSpawners() {
		...
		Element docEle = parseDomElement(xml);
		TaskManager tm = new TaskManager(10, 10,-1,null);
		Map<String, TaskSpawner> spawners = AgentXmlFactory.getTaskSpawners(docEle, tm);
		assertEquals(2, spawners.size());
		TaskSpawner ts = spawners.get("defaultTS");
		assertTrue(ts != null);
		assertEquals("50", ts.getParam("param1", ""));
		assertEquals(50, (int) ts.getParam("param2", 0));
		ts = spawners.get("nodefaultTS");
		assertTrue(ts != null);
	...
	public void testGetTasks() {
		...
		Element docEle = parseDomElement(xml);
		List<AgentXmlFactory.TaskData> toRun = AgentXmlFactory.getTasks(docEle, ts);
	...
	public void testGetTask() {
		...
		AgentXmlFactory.TaskData td = AgentXmlFactory.getTask(docEle, null);
	...
	public void testGetTask2() {
		...
		AgentXmlFactory.TaskData td = AgentXmlFactory.getTask(docEle, 10);
	...
	public void testGetTasksDefaultTicksPerRun() {
		...
		Element docEle = parseDomElement(xml);
		int tpr = AgentXmlFactory.getTasksDefaultTicksPerRun(docEle);
		assertEquals(5, tpr);
	}
	...
	public void testGetAssociatedModules() {
		...
		AgentXmlFactory.getAssociatedModules(docEle, initializable, toAssociate);
	...
	public void testGetListeners() {
		...
		AgentXmlFactory.getListeners(docEle, topModule);
	...
	public void testGetListener1() {
		...
		AgentXmlFactory.getListener(docEle, topModule);
		assertTrue(!smm.listeners.isEmpty());
		assertEquals(listener, smm.listeners.get(0));
	}
	...
	public void testAssociateModules() {
		...
		AgentXmlFactory.associateModules(toAssoc, topModule);
	...
	public void testInitializeModules() {
		...
		AgentXmlFactory.initializeModules(a, toInit);
	...
	public void testInitializeTasks() {
		...
		AgentXmlFactory.initializeTasks(null, toRun);
